(function ($) {
	...
	/* Our Works Slider JS */
	if ($('.works-slider-elite').length) {
		const works_slider_elite = new Swiper('.works-slider-elite .swiper', {
			slidesPerView : 1,
			speed: 1500,
			parallax: true,
			spaceBetween: 30,
			pagination: {
			el: '.swiper-pagination-elite',
			clickable: true,
	...
	/* Toolkit Slider JS */
	if ($('.toolkit-slider-royal').length) {
		const toolkit_slider_royal = new Swiper('.toolkit-slider-royal .swiper', {
			slidesPerView : 1,
			speed: 1500,
			spaceBetween: 30,
			loop: true,
	...
	if ($('.testimonial-slider-royal').length) {
		const testimonial_slider_royal = new Swiper('.testimonial-slider-royal .swiper', {
			...
			pagination: {
				el: '.testimonials-pagination-royal',
				clickable: true,
			},
		});
	}
